  ...
  if (isFocusRunning(id)) {
    return (
      <View
        ...
        <Text className={`${styles.timerValue} ${styles.focusTimerValue} ${fontSizeClasses.base}`}>
  ...
  if (isBreakRunning(id)) {
    return (
      <View
        ...
        <Text className={`${styles.timerValue} ${styles.breakTimerValue} ${fontSizeClasses.base}`}>
